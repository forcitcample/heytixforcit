...
<p>
	<label><?php _e('Show Avatar:', 'fitness-wellness'); ?></label>
	<?php
...
<p>
	<label><?php _e('Show Post Count:', 'fitness-wellness'); ?></label>
	<?php
...
<p>
	<label for="<?php echo $this->get_field_id('count'); ?>"><?php _e('How many authors to display?', 'fitness-wellness'); ?></label>
		...
		<div class="hidden_el" <?php if($i>$count):?>style="display:none"<?php endif;?>>
			<p>
				<label for="<?php echo $this->get_field_id($author_id); ?>">
					<?php _e('Author:', 'fitness-wellness')?>
				</label>
			...
			<p>
				<label for="<?php echo $this->get_field_id( $author_desc ); ?>">
					<?php _e('Author Description (optional):', 'fitness-wellness')?>
				</label>
