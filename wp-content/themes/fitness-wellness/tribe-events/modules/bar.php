			...
			<div class="tribe-bar-filters">
				<div class="tribe-bar-filters-inner tribe-clearfix">
					...
					<div class="tribe-bar-submit">
						<button class="tribe-no-param button vamtam-button accent8 hover-accent1" type="submit" name="submit-bar"><span class="icon"><?php wpv_icon('search1') ?></span><span class="btext"><?php _e( 'Find Events', 'tribe-events-calendar' ) ?></span></button>
