...
class WPV_Portfolio {
	...
	public static function shortcode($atts, $content = null, $code = 'portfolio') {
		...
		$image_suffix = $sortable === 'masonry' ? 'masonry' : 'loop';
		$image_sizes = array(
			"portfolio-{$image_suffix}-1", "portfolio-{$image_suffix}-2", "portfolio-{$image_suffix}-3", "portfolio-{$image_suffix}-4",
			"portfolio-{$image_suffix}-1@2x", "portfolio-{$image_suffix}-2@2x", "portfolio-{$image_suffix}-3@2x", "portfolio-{$image_suffix}-4@2x",
		);
