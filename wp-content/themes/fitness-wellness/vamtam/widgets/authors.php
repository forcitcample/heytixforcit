...
class wpv_authors extends WP_Widget {
	...
	public function __construct() {
		$widget_opts = array(
			...
			'description' => __('List of authors and their descriptions', 'fitness-wellness')
			);
		parent::__construct('wpv_authors', __('Vamtam - Authors', 'fitness-wellness'), $widget_opts);
	}
	...
	public function widget($args, $instance) {
		...
		$title = apply_filters('widget_title', empty($instance['title']) ? __('Authors', 'fitness-wellness') : $instance['title'], $instance, $this->id_base);
