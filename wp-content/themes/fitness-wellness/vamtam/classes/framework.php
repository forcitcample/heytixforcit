...
class WpvFramework {
	...
	private function image_size_derivatives( $name, $width, $height, $crop = false ) {
	...
	public function theme_supports() {
		...
		if ( function_exists( 'register_nav_menus' ) ) {
			register_nav_menus(
				array(
					'menu-header' => __( 'Menu Header', 'fitness-wellness' ),
					'menu-top' => __( 'Menu Top', 'fitness-wellness' ),
				)
			);
		}

		$this->image_size_derivatives( 'posts-widget-thumb', 60, 60, true );
		$this->image_size_derivatives( 'posts-widget-thumb-small', 43, 43, true );
		...
		$this->image_size_derivatives( 'post-loop', $post_loop_width, $height, $size_info['post-loop']->crop );
		...
		foreach ( $single_sizes as $name ) {
			...
			$this->image_size_derivatives( $name, $width, $height, $size_info[$name]->crop );
		}

		for ( $num_columns = 1; $num_columns <= 4; $num_columns++ ) {
			$small_width = ( $width + 30 ) / $num_columns - 30;

			$this->image_size_derivatives( 'portfolio-masonry-'.$num_columns, $small_width, 0 );
			...
			foreach ( $columnated_sizes as $name ) {
				...
				$this->image_size_derivatives( $name.'-'.$num_columns, $col_width, $height, $size_info[$name]->crop );
			}
		}
	}
	...
	private function load_languages() {
		load_theme_textdomain( 'fitness-wellness', THEME_DIR . 'languages' );
	}
	...
	public function load_types() {
		...
		register_post_type(
			'portfolio', array(
				'labels' => array(
					'name' => _x( 'Portfolios', 'post type general name', 'fitness-wellness' ),
					'singular_name' => _x( 'Portfolio', 'post type singular name', 'fitness-wellness' ),
					'add_new' => _x( 'Add New', 'portfolio', 'fitness-wellness' ),
					'add_new_item' => __( 'Add New Portfolio', 'fitness-wellness' ),
					'edit_item' => __( 'Edit Portfolio', 'fitness-wellness' ),
					'new_item' => __( 'New Portfolio', 'fitness-wellness' ),
					'view_item' => __( 'View Portfolio', 'fitness-wellness' ),
					'search_items' => __( 'Search Portfolios', 'fitness-wellness' ),
					'not_found' => __( 'No portfolios found', 'fitness-wellness' ),
					'not_found_in_trash' => __( 'No portfolios found in Trash', 'fitness-wellness' ),
					'parent_item_colon' => '',
				),
				'singular_label' => __( 'portfolio', 'fitness-wellness' ),
				'public' => true,
		...
		register_taxonomy(
				...
				'hierarchical' => true,
				'labels' => array(
					'name' => _x( 'Portfolio Categories', 'taxonomy general name', 'fitness-wellness' ),
					'singular_name' => _x( 'Portfolio Category', 'taxonomy singular name', 'fitness-wellness' ),
					'search_items' => __( 'Search Portfolio Categories', 'fitness-wellness' ),
					'popular_items' => __( 'Popular Portfolio Categories', 'fitness-wellness' ),
					'all_items' => __( 'All Portfolio Categories', 'fitness-wellness' ),
					'parent_item' => null,
					'parent_item_colon' => null,
					'edit_item' => __( 'Edit Portfolio Category', 'fitness-wellness' ),
					'update_item' => __( 'Update Portfolio Category', 'fitness-wellness' ),
					'add_new_item' => __( 'Add New Portfolio Category', 'fitness-wellness' ),
					'new_item_name' => __( 'New Portfolio Category Name', 'fitness-wellness' ),
					'separate_items_with_commas' => __( 'Separate Portfolio category with commas', 'fitness-wellness' ),
					'add_or_remove_items' => __( 'Add or remove portfolio category', 'fitness-wellness' ),
					'choose_from_most_used' => __( 'Choose from the most used portfolio category', 'fitness-wellness' )
				),
				'show_ui' => true,
				'query_var' => true,
				'rewrite' => false,
		...
		register_post_type(
			'testimonials', array(
				'labels' => array(
					'name' => _x( 'Testimonials', 'post type general name', 'fitness-wellness' ),
					'singular_name' => _x( 'Testimonial', 'post type singular name', 'fitness-wellness' ),
					'add_new' => _x( 'Add New', 'testimonials', 'fitness-wellness' ),
					'add_new_item' => __( 'Add New Testimonial', 'fitness-wellness' ),
					'edit_item' => __( 'Edit Testimonial', 'fitness-wellness' ),
					'new_item' => __( 'New Testimonial', 'fitness-wellness' ),
					'view_item' => __( 'View Testimonial', 'fitness-wellness' ),
					'search_items' => __( 'Search Testimonials', 'fitness-wellness' ),
					'not_found' => __( 'No testimonials found', 'fitness-wellness' ),
					'not_found_in_trash' => __( 'No testimonials found in Trash', 'fitness-wellness' ),
					'parent_item_colon' => '',
				),
				'singular_label' => __( 'testimonial', 'fitness-wellness' ),
				'public' => true,
		...
		register_taxonomy(
			'testimonials_category','testimonials',array(
				'hierarchical' => true,
				'labels' => array(
					'name' => _x( 'Testimonials Category', 'taxonomy general name', 'fitness-wellness' ),
					'singular_name' => _x( 'Testimonial Category', 'taxonomy singular name', 'fitness-wellness' ),
					'search_items' => __( 'Search Categories', 'fitness-wellness' ),
					'popular_items' => __( 'Popular Categories', 'fitness-wellness' ),
					'all_items' => __( 'All Categories', 'fitness-wellness' ),
					'parent_item' => null,
					'parent_item_colon' => null,
					'edit_item' => __( 'Edit Testimonials Category', 'fitness-wellness' ),
					'update_item' => __( 'Update Testimonials Category', 'fitness-wellness' ),
					'add_new_item' => __( 'Add New Testimonials Category', 'fitness-wellness' ),
					'new_item_name' => __( 'New Testimonials Category Name', 'fitness-wellness' ),
					'separate_items_with_commas' => __( 'Separate Testimonials category with commas', 'fitness-wellness' ),
					'add_or_remove_items' => __( 'Add or remove testimonials category', 'fitness-wellness' ),
					'choose_from_most_used' => __( 'Choose from the most used testimonials category', 'fitness-wellness' )
				),
				'show_ui' => true,
				'query_var' => false,
				'rewrite' => false,
	...
	public function setup_adminbar() {
		...
		$wp_admin_bar->add_menu(
			array(
				'parent' => false,
				'id' => 'wpv-settings',
				'title' => __( 'Vamtam', 'fitness-wellness' ),
				'href' => admin_url( 'admin.php?page=wpv_general' ),
				'meta' => false,
			)
		);

		$adv_name = __( 'Theme options', 'fitness-wellness' );

		$pages = array(
			'general' => __( 'General Settings', 'fitness-wellness' ),
			'layout' => __( 'Layout', 'fitness-wellness' ),
			'styles' => __( 'Styles', 'fitness-wellness' ),
			'import' => __( 'Quick Import', 'fitness-wellness' ),
			'help' => __( 'Help', 'fitness-wellness' ),
		);
