...
class WpvSidebars {
	...
	public function __construct() {
		$this->sidebars = array(
			'page' => __( 'Shared Page Widget Area', 'fitness-wellness' ),
			'blog' => __( 'Blog Widget Area', 'fitness-wellness' ),
			'portfolio' => __( 'Portfolio Widget Area', 'fitness-wellness' ),
		);

		if ( wpv_has_woocommerce() )
			$this->sidebars['wpv-woocommerce'] = __( 'WooCommerce Widget Area', 'fitness-wellness' );
