	...
	public static function admin_scripts() {
		...
		wp_localize_script(
			'wpv_admin', 'WPV_ADMIN', array(
				...
				'addNewIcon' => __( 'Add New Icon', 'fitness-wellness' ),
				'iconName'   => __( 'Icon', 'fitness-wellness' ),
				'iconText'   => __( 'Text', 'fitness-wellness' ),
				'iconLink'   => __( 'Link', 'fitness-wellness' ),
				'iconChange' => __( 'Change', 'fitness-wellness' ),
