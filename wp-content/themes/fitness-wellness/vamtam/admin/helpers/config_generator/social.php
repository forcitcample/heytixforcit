...
$contexts = array(
	'post'      => __('Post', 'fitness-wellness'),
	'page'      => __('Page', 'fitness-wellness'),
	'portfolio' => __('Portfolio', 'fitness-wellness'),
	'product'   => __('Product', 'fitness-wellness'),
	'lightbox'  => __('Lightbox', 'fitness-wellness'),
	'tribe'     => __('Tribe Events', 'fitness-wellness'),
);
