...
function edit_portfolio_columns($portfolio_columns) {
	$columns = array(
		...
		"title" => _x('Title', 'column name', 'fitness-wellness' ),
		"portfolio_category" => __('Categories', 'fitness-wellness' ),
		"author" => __('Author', 'fitness-wellness' ),
		"date" => __('Date', 'fitness-wellness' ),
		"thumbnail" => __('Thumbnail', 'fitness-wellness' )
	);
