...
<div id="htmh-tribe-single-event" class="clearfix">
	...
	<div class="wpv-tribe-events-meta">
		...
		<?php do_action( 'tribe_events_single_event_after_the_meta_top' ) ?>


		<?php $text = wpv_get_option( 'events-after-details-content' ); ?>
		<?php if ( ! empty( $text ) ): ?>
