			...
			<li class="<?php tribe_events_event_classes() ?>">
				...
				<div class="vcard adr location">
					...
					<?php _e('Cost:', 'tribe-events-calendar') ?>
							<span class="tribe-events-event-meta-value" itemprop="price"><?php echo $cost; ?>
					
						<?php endif; ?>
					
					<span class="tribe-events-event-meta-desc"><?php _e('Buy now:', 'tribe-events-calendar') ?>
					<span class="tribe-events-event-meta-value" itemprop="buy-now"><a href="<?php echo tribe_get_event_link(); ?>" class="tribe-events-button-book-now">Buy Now</a>
				</div>
