...
<div class="logo-wrapper">
	<a href="#" id="mp-menu-trigger" class="icon-b" data-icon="<?php wpv_icon('menu1') ?>"><?php _e('Open/Close Menu', 'fitness-wellness') ?></a>
	<?php
	...
	?>
	<a href="http://www.heytix.com" title="<?php bloginfo( 'name' ) ?>" class="logo <?php if ( empty( $logo ) || $logo_type === 'site-title' ) echo 'text-logo' //xss ok ?>" style="min-width:<?php echo $logo_size['width']/2 ?>px"><?php
	...
	<div class="mobile-logo-additions">
		<?php if ( wpv_has_woocommerce() ): ?>
			...
			<a class="vamtam-cart-dropdown-link no-dropdown icon theme" href="<?php echo esc_attr( $woocommerce->cart->get_cart_url() ) ?>">
				<span class="icon theme"><i class="fa fa-shopping-cart fa-lg"></i></span>
