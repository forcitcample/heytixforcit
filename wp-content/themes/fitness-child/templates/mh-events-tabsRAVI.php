<div class="ht-event-tabs">
  ...
  <select name="quantity" value="1" title="Qty" class="input-text qty text qbox"><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option></select>
  </div>
</div>
...
<div class="productfooter">
 ...
 <img src="'.$product_image.'" style="height::40px; width:50px;" class="pro_img"/>
 <span class="price"><sup>$</sup>'.$price = get_post_meta($loop->post->ID, '_regular_price', true).'<sup>.00</sup></span>
 </div>
