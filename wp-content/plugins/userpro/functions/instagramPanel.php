...
<?php global $userpro; ?>
	...
	function wpinLoginInstagram(){
		wpin_instagram_auth_window=window.open('<?php echo WPL_PLUGIN_PATH;?>userpro/lib/instagram-auth/instagramAuth.php?plugin_url=<?php echo WPL_PLUGIN_PATH;?>&k=<?php echo userpro_get_option('instagram_app_key');?>&s=<?php echo userpro_get_option('instagram_Secret_Key');?>','name','width=600,height=500');
	}
