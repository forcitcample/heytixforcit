...
class FUE_Coupons{
    ...
    /**
     * Add the {coupon_code} placeholder to the list of available email variables
     */
    public function form_variables() {
        echo '<li class="var hideable var_coupon class_coupon"><strong>{coupon_code}</strong> <img class="help_tip" title="'. __('Coupon code generated', 'follow_up_emails') .'" src="'. WC()->plugin_url() .'/assets/images/help.png" width="16" height="16" /></li>';
    }
