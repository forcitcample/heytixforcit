        ...
        register_post_type( Follow_Up_Emails::$post_type,
            array(
                'labels'        => array(
                    ...
                    'add_new'            => __( 'Add Email', 'follow_up_emails' ),
                    'add_new_item'       => __( 'Add New Email', 'follow_up_emails' ),
                    'edit'               => __( 'Edit', 'follow_up_emails' ),
                    'edit_item'          => __( 'Edit Email', 'follow_up_emails' ),
                    'new_item'           => __( 'New Follow-Up Email', 'follow_up_emails' ),
                    'view'               => __( 'View Email', 'follow_up_emails' ),
                    'view_item'          => __( 'View Email', 'follow_up_emails' ),
                    'search_items'       => __( 'Search Follow-Up Emails', 'follow_up_emails' ),
                    'not_found'          => __( 'No Emails found', 'follow_up_emails' ),
                    'not_found_in_trash' => __( 'No Emails found in trash', 'follow_up_emails' ),
                ),
                'public'            => false,
                'show_ui'           => true,
                'show_in_menu'      => false,
