            ...
            <tbody>
                <tr valign="top" class="send_type_tr">
                    ...
                    <td class="send_type_td">
                        <select name="send_type" id="send_type">
                            ...
                            <option value="subscribers"><?php _e('Subscribers', 'follow_up_emails'); ?></option>
                ...
                <tr valign="top" class="sending_schedule_picker">
                    ...
                    <td>
                        ...
                        <input type="number" min="0" max="55" step="5" name="sending_schedule_minute" value="" placeholder="<?php _e('Minute', 'follow_up_emails'); ?>" style="width:80px;" />
