...
<div id="fue-email-details-content" class="panel-wrap email_details" style="display: none;">
    ...
    <ul class="email_details_tabs fue-tabs">
        ...
        $email_details_tabs = apply_filters( 'fue_email_details_tabs', array(
            ...
            'email_settings' => array(
                'label'  => __( 'Email Settings', 'follow_up_emails' ),
        ...
        <?php if ( !in_array( $email->type, array('signup', 'manual') ) ): ?>
            ...
            <p class="form-field">
                <label for="adjust_date">
                    <?php _e('Adjust send date', 'follow_up_emails'); ?>
                </label>
                ...
                <img width="16" height="16" src="<?php echo FUE_TEMPLATES_URL; ?>/images/help.png" class="help_tip" title="<?php _e('Setting this will change the email date to further in the future if the customer already has the same email queued for a future send', 'follow_up_emails'); ?>">
            </p>
        <?php endif; ?>
    ...
    <div id="tracking_details" class="panel fue_panel">
        ...
        <p class="form-field tracking_on" style="display: none;">
            ...
            <input type="text" name="tracking" id="tracking" value="<?php echo esc_attr($email->tracking); ?>" placeholder="e.g. utm_campaign=Follow-up-Emails-by-75nineteen" style="width: 75%;" />
