<div id="email-actions-box" class="submitbox">
    ...
    <div id="publishing-actions">
        ...
        <div id="publishing-action">
            <span class="spinner"></span>
            <input type="submit" class="button save_email button-primary tips" name="save" value="<?php _e( 'Save Email', 'follow-up-emails' ); ?>" data-tip="<?php _e( 'Save/update the Email', 'woocommerce' ); ?>" />
        </div>
        <div class="clear"></div>
    </div>
</div>