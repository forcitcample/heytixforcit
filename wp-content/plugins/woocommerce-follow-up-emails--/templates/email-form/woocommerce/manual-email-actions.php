<div class="send-type-customer send-type-div">
    <input type="hidden" name="recipients[]" id="recipients" class="email-search-select" data-multiple="true" data-placeholder="Search by customer name or email..." style="width: 600px;"></select>
</div>
<div class="send-type-product send-type-div">
    <input type="hidden" id="product_ids" name="product_ids[]" class="wc-product-search" data-multiple="true" data-placeholder="<?php _e('Search for a product&hellip;', 'woocommerce'); ?>" style="width: 600px"></select>
</div>
