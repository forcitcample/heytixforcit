<div class="options_group">
    <p class="form-field">
        <select name="meta[wootickets_type]" id="wootickets_type" class="select2">
            <option value="all" <?php selected( $wootickets_type, 'all' ); ?>><?php _e('All tickets', 'follow_up_emails'); ?></option>
            <option value="products" <?php selected( $wootickets_type, 'products' ); ?>><?php _e('A specific ticket', 'follow_up_emails'); ?></option>
            <option value="categories" <?php selected( $wootickets_type, 'categories' ); ?>><?php _e('A specific category', 'follow_up_emails'); ?></option>
        </select>
    </p>
</div>

<p class="field hideable ticket_product_tr">
...
<p class="field hideable ticket_category_tr">
