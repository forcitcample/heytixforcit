...
$url = wp_nonce_url( 'admin.php?page=followup-emails-addons&action=uninstall_template&template='. $_GET['template'], 'template_uninstall');
$target_directory = trailingslashit( get_template_directory() );
...
show_message( '<a href="admin.php?page=followup-emails-addons">'. __('Go back', 'follow_up_emails') .'</a>');