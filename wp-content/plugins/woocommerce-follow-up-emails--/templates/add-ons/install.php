...
$url = wp_nonce_url( 'admin.php?page=followup-emails-addons&action=install_template&template='. $_GET['template'], 'template_install');
...
$response = wp_remote_get( $_GET['template'] );
