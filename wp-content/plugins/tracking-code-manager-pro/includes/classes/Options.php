...
class TCMP_Options {
    ...
    public function getTrackingLastSend() {
        return $this->getOption('TrackingLastSend['.TCMP_PLUGIN_NAME.']', 0);
    }
    public function setTrackingLastSend($value) {
        $this->setOption('TrackingLastSend['.TCMP_PLUGIN_NAME.']', $value);
    }
    public function getPluginInstallDate() {
        return $this->getOption('PluginInstallDate['.TCMP_PLUGIN_NAME.']', 0);
    }
    public function setPluginInstallDate($value) {
        $this->setOption('PluginInstallDate['.TCMP_PLUGIN_NAME.']', $value);
    }
    public function getPluginUpdateDate() {
        return $this->getOption('PluginUpdateDate['.TCMP_PLUGIN_NAME.']', 0);
    }
    public function setPluginUpdateDate($value) {
        $this->setOption('PluginUpdateDate['.TCMP_PLUGIN_NAME.']', $value);
    }
