jQuery.noConflict();
 ...
 jQuery(document).ready(function($){
	jQuery(".option-title").removeClass('open');
	jQuery(".ino-toggle .option-content").addClass('hide_inoplugs_toggle');
 
 	jQuery(".option-title").click(function(){
		jQuery(this).toggleClass('open').next().toggle('slow');
	});
 });
...
jQuery(document).ready(function(){
	...
	jQuery('a[href*=#]').ino_smoothscroll();
	
	//activates the hover effect for image links
	if(jQuery.fn.ino_activate_hover_effect)		
	jQuery('.container').ino_activate_hover_effect();
});

function my_lightbox($elements)
{	
	jQuery($elements).prettyPhoto({social_tools: false});
}


(function($)
{
	$.fn.ino_smoothscroll = function(variables) 
	{
...
(function($)
{
	$.fn.ino_activate_hover_effect = function(variables) 
	{
		var defaults = 
		{
