...
class Heytix_SRE_Row_Total_Sign_Ups extends Heytix_SRE_Report_Row {
	...
	public function __construct( $date_range ) {
		parent::__construct( $date_range, 'total-sign-ups', __( 'Total Sign Ups', 'heytix-sales-report-email' ) );
	}
