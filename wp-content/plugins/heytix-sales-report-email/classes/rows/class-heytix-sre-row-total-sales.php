...
class Heytix_SRE_Row_Total_Sales extends Heytix_SRE_Report_Row {
	...
	public function __construct( $date_range ) {
		parent::__construct( $date_range, 'total-sales', __( 'Sales in this period', 'heytix-sales-report-email' ) );
	}
