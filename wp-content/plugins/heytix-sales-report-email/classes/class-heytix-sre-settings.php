...
class Heytix_SRE_Settings {
	...
	public function add_section( $sections ) {
		$sections['heytix_sre_sales_report_email'] = __( 'Sales Reports', 'heytix-sales-report-email' );
	...
	public function add_email_class( $emails ) {
		$emails['Heytix_SRE_Sales_Report_Email'] = new Heytix_SRE_Sales_Report_Email();
