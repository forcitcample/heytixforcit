...
interface Heytix_SRE_IReport_Row {
...
abstract class Heytix_SRE_Report_Row implements Heytix_SRE_IReport_Row {

	/**
	 * @var Heytix_SRE_Date_Range
	 */
	private $date_range;
	 ...
	 *
	 * @param Heytix_SRE_Date_Range $date_range
	 *
	 * @access public
	 * @since  1.0.0
	 */
