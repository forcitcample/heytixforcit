...
class WC_Product_Finder_Widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		// Load search form
		$html = woocommerce_product_finder( array( 'use_category' => $instance['use_category'] , 'search_attributes' => $used_atts ) , false );
...
/* Register the widget. */
add_action( 'widgets_init', create_function( '', 'return register_widget("WC_Product_Finder_Widget");' ), 1 );
?>