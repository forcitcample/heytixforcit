...
class WooCommerce_Product_Finder_Admin {
	...
	public function settings( $settings ) {
		...
		$settings[] = array( 'name' => __( 'Product Finder', 'woocommerce' ), 'type' => 'title', 'desc' => __( 'Select which product criteria (category/attributes) will be included in your site\'s Product Finder and which one will be selected by default.' , 'woocommerce-product-finder' ), 'id' => 'advanced_search' );
