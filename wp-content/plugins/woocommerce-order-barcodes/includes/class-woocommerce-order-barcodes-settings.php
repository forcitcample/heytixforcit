...
class WooCommerce_Order_Barcodes_Settings {
	...
	public function colour_settings () {
		?><tr valign="top" class="wc_order_barcodes_colours">
			<th scope="row" class="titledesc">
				<?php _e( 'Barcode Colours', 'woocommerce' ); ?>
			</th>
		    <td class="forminp"><?php
	    		...
	    		$wc_settings_general->color_picker( __( 'Foreground', 'woocommerce-order-barcodes' ), 'wc_order_barcodes_colours_foreground', $colours['foreground'], __( 'Barcode image and text colour', 'woocommerce-order-barcodes' ) );
	    		$wc_settings_general->color_picker( __( 'Background', 'woocommerce-order-barcodes' ), 'wc_order_barcodes_colours_background', $colours['background'], __( 'Barcode background colour', 'woocommerce-order-barcodes' ) );
	 ...
	 * @return Main WooCommerce_Order_Barcodes_Settings instance
	 */
