...
<div class="entry-meta eventorganiser-event-meta">
	...
	<!-- Event details -->
		<h4><?php _e('Artist Details', 'eventorganiser') ;?></h4>
	...
	<li><strong><?php _e('Website', 'eventorganiser') ;?>:</strong> <?php echo get_post_meta($post->ID, 'website', true); ?></li>
	<li><strong><?php _e('Facebook', 'eventorganiser') ;?>:</strong> <?php echo get_post_meta($post->ID, 'facebook', true); ?></li>
	<li><strong><?php _e('Myspace', 'eventorganiser') ;?>:</strong> <?php echo get_post_meta($post->ID, 'myspace', true); ?></li>
	<li><strong><?php _e('Twitter', 'eventorganiser') ;?>:</strong> <?php echo get_post_meta($post->ID, 'twitter', true); ?></li>
	<li><strong><?php _e('Instagram ', 'eventorganiser') ;?>:</strong> <?php echo get_post_meta($post->ID, 'instagram', true); ?></li>
	<li><strong><?php _e('iTunes ', 'eventorganiser') ;?>:</strong> <?php echo get_post_meta($post->ID, 'itunes', true); ?></li>
	<li><strong><?php _e('YouTube ', 'eventorganiser') ;?>:</strong> <?php echo get_post_meta($post->ID, 'youtube', true); ?></li>
	<li><strong><?php _e('SoundCloud ', 'eventorganiser') ;?>:</strong> <?php echo get_post_meta($post->ID, 'sound', true); ?></li>
	
	<?php if(get_post_meta($post->ID, 'youtube_embed', true) != "")
	{?>
	<li><strong><?php _e('Youtube Video ', 'eventorganiser') ;?></strong>
	<iframe width="560" height="315" src="<?php echo get_post_meta($post->ID, 'youtube_embed', true); ?>"></iframe>
	</li>
	<?php } ?>


	<?php if(get_post_meta($post->ID, 'soundcloud_embed', true) != "")
	{?>
	<li><strong><?php _e('SoundCloud Video ', 'eventorganiser') ;?></strong>
	<iframe width="560" height="315" src="<?php echo get_post_meta($post->ID, 'soundcloud_embed', true); ?>"></iframe>
	</li>
	<?php } ?>
