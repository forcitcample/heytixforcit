 ...
 *
 * You can use this to edit how the output of the event list widget. For the shortcode [eo_Artist] see shortcode-event-list.php
 *
	...
	<ul <?php echo $id; ?> class="<?php echo esc_attr($classes);?>" > 
		...
		<?php while( $eo_event_loop->have_posts() ): $eo_event_loop->the_post(); ?>
			...
			<?php 
				...
				//For non-all-day Artist, include time format
...
<?php elseif( ! empty($eo_event_loop_args['no_Artist']) ): ?>

	<ul id="<?php echo esc_attr($id);?>" class="<?php echo esc_attr($classes);?>" > 
		<li class="eo-no-Artist" > <?php echo $eo_event_loop_args['no_Artist']; ?> </li>
	</ul>
