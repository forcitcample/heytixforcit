...
function eventorganiser_event_detail_dialog(){
	 ...
	 * @ignore
	 */
	$tabs = apply_filters( 'eventorganiser_calendar_dialog_tabs', array( 'summary' => __( 'Artist Details', 'eventorganiser' ) ) );
	
	printf( "<div id='events-meta' class='eo-dialog' style='display:none;' title='%s'>", esc_attr__( 'Event Detail1', 'eventorganiser' ) );
