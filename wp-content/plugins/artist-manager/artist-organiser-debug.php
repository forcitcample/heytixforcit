...
class EventOrganiser_Debug_Page extends EventOrganiser_Admin_Page
{
	...
	function page_actions(){
		...
		$eo_debugger->set_db_tables( 'eo_Artist', 'eo_venuemeta' );
	...
	<div class="wrap">
		...
		echo " ";
		_e( "The 'system info' link in under the Artist admin tab is only visible to admins and only when <code>WP_DEBUG</code> is set to <code>true</code>.", 'eventorganiser' );
		?>
		</p>
		<p class="description">
		<?php 
